...
const inputStyles =
  ...
  "transition-all placeholder:text-zinc-700 disabled:bg-slate-50 disabled:text-zinc-700";
  ...
  return (
    <div className="w-full">
      ...
      <button
        ...
        className="group flex w-full items-center justify-between rounded-xl border border-slate-200 bg-white px-4 py-3 transition-all hover:border-slate-300 hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50"
      >
        <div className="flex items-center gap-3 overflow-hidden">
          ...
          <div className="min-w-0 text-left">
            ...
            {fileName ? (
              <p className="truncate text-xs text-zinc-700">{fileName}</p>
            ) : (
        ...
        <span className="rounded-md border border-slate-200 bg-slate-50 px-3 py-1 text-xs font-medium text-slate-600 transition-colors group-hover:bg-slate-100">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <button
              type="button"
              onClick={() => router.back()}
              className="text-zinc-700 hover:text-slate-600 transition-colors p-1 -ml-1 rounded-lg hover:bg-slate-100"
              aria-label="Go back"
            >
              <ArrowLeft size={20} />
            </button>
