...
import {
  ...
  LuFileImage as FileImage, LuPencil as Pencil, LuDownload as Download,
} from "react-icons/lu";
...
export default function PhotoDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    PhotoService.getPhotoById<Photo>(id).then(res => {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      <div className="max-w-4xl mx-auto px-4 py-8 flex flex-col gap-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg font-semibold">
              Photo <span className="text-gray-400 font-normal">#{photo.userPhotoNumber}</span>
            </h1>
          </div>
        ...
        {/* Image — original pixel dimensions, scroll if larger than viewport */}
